...
// //        document.body.innerHTML = document.body.innerHTML.replace(/a/g, 'bbbbb');
//         sendResponse($("body").html());
//     }
// });
// window.onload = function(){
//     document.body.innerHTML = document.body.innerHTML.replace(/bitch/g, 'bbbbb');
// }
...
setInterval(function(){
    $.each($("yt-formatted-string"), function(i,ele){
        ...
        ele.innerHTML = ele.innerHTML.replace(re, 'bbbbb')
    })
},10000)

// document.body.innerHTML = document.body.innerHTML.replace(/bitch/g, 'blob');
